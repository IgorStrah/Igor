...
int main(void)
{
  ...
  uint8_t flickerstrength=4,flickerstrength1=4,mode = 1;   // 1: day, 2: candle, 0 night;
  ...
  while(1)
  {
    ...
    while (minutes)
    {
      ...
      {
        minutes--;
        flickerstrength= 2 + (RND_Num >> 14); // 1 ... 4
        flickerstrength1= 4 + (RND_Num >> 4); // 1 ... 4
      }
      ...
      OCR1B = 80+2*flickerstrength*(7-r)*state; // 80 +/- 56 -> 24 .. 136
