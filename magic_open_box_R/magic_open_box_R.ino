...
if (step==2&&position>=120)
{step=1;}

if (step==1&&position>=174)
{step=0;}

if (step!=0&&position<=175)
{
position=position+5;
}
...
if (step==0 && ((newCode == 1111000004)||(newCode == 16716015)))
{
step=1;
position=120;
newCode=0;
}
if (step==1 && ((newCode == 1111000008)||(newCode == 16730805)))
{
step=2;
position=60;
  newCode=0;
}
if (step==2 && ((newCode == 1111000005)||(newCode == 16726215)))
{
  position=0;
       Serial.println("On");
  myservo0.write(position); 
